...
*Here is how you can identify polynomial graphs :*

![Identifying polynomial graphs](img/poly_graphs.png)
_A polynomial graph consist the of smooth curves and is continues lines_


### Graphs of Polynomial Functions: End Behavior 

The end behavior of a polynomial is a description of what happens as x increases in the positive and negative direction. 

The end behavior of a graph can be described as such :  

![End behavior of a graph ](img/end_be.png)


Steps to sketch a graph of a polynomial:
1. Think about basic graph in your mind, roughly sketch it
2. Zero's (x-intercept) solve all solutions to make polynomial = 0. write multiplicity to each zero.
3. y-intercept : if any make sure you plug x=0 in the original polynomial
4. Test points : Plug in test points in each interval created by the solutions. Make sure you plug in the original polynomial. Use multiplicity to decide the graph behavior near zeros.
5. Verify step 1, especially ending behavior
